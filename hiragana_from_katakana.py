...
if "hiragana_list_1" not in st.session_state or "katakana_list_1" not in st.session_state:
    hiragana_list , katakana_list = get_questions_from_csv(csv_file_name)
    st.session_state.hiragana_list_1 = hiragana_list
    st.session_state.katakana_list_1 = katakana_list

hiragana_list = st.session_state.hiragana_list_1
katakana_list = st.session_state.katakana_list_1

st.write("### Let's start! \n\n\n\n")
st.write("##### Write the correct hiragana of the given katakana! \n\n")
...
if(st.button("### Retry")):
    del st.session_state.katakana_list_1
    del st.session_state.hiragana_list_1
